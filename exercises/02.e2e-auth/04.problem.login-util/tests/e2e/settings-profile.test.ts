...
import { authenticator, verifyLogin } from '~/utils/auth.server'
...
test('Users can update their basic info', async ({ page, baseURL }) => {
	// 🐨 extract everything between me and the next Kody into a loginPage utility
	// in the playwright-utils file
	...
	// 🐨 everything above me should be in the utility

	// 🐨 use the login utility here
