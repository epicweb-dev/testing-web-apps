...
I've you've used Testing Library in the past, you may be interested in reading
[Common mistakes with React Testing Library](https://kentcdodds.com/blog/common-mistakes-with-react-testing-library)
as you may be making them yourself (don't feel bad, they're common 😅).

## Remix

When our components are rendered, they are using a context provider from Remix.
When we try to render our components in our test, things like `useLoaderData`
and `<Link>` will expect to have that context available. The tricky bit with
Remix is that so much of what you're doing relies on the routing layer which
often involves loaders and actions.
